...
document.getElementById('cheapoBackgroundArea').style.backgroundRepeat = "no-repeat";
document.getElementById('cheapoBackgroundArea').style.backgroundSize = "cover";
document.getElementById('cheapoBackgroundArea').style.backgroundAttachment = "fixed";

//////////////////////////////////////
//ESTABLISH TEMPLATE LOGIC VARIABLES//
//////////////////////////////////////
//cheapoContentComponent / careerTag mechanism
	//establish maximum amount of content components possible
	var maximumAllowedContentComponents = 13;
	
	//establish cheapo list of content component id's array
	var cheapoContentComponentIdList = [];
	
	//populate cheapoContentComponentIdList
	for(var i = 0; i < maximumAllowedContentComponents; i ++)
		cheapoContentComponentIdList.push ( "cheapoContentComponentEntity" + i );
	...
	{
		//toggleContents ("cheapoContentComponentEntity0"); ( );
	}
	...
	{
		for (var i = 0; i < maximumAllowedContentComponents; i ++)
			if ( activeContentId == cheapoContentComponentIdList[i] )
			{
				document.getElementById ( cheapoContentComponentIdList [i] ).style.display="block"; //show entity
			}
			else
			{
				document.getElementById ( cheapoContentComponentIdList [i] ).style.display="none"; //hide all other entities
			}
	}	
	///////////////////////////////////////////////////////////
